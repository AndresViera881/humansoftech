...
const WA_SVG = (
  <svg className="w-5 h-5 flex-shrink-0 text-green-400" viewBox="0 0 24 24" fill="currentColor">
            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 pt-1">
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-base font-bold text-white transition-all duration-150 hover:brightness-125 active:scale-[0.98]"
