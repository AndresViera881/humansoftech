            ...
            <div className="flex flex-col gap-6">
              ...
              <div className="flex flex-col gap-3 pt-1">
                <button
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-base font-bold text-white transition-all duration-200 active:scale-[0.98]"
                  style={added
                    ? { background: '#16a34a', boxShadow: '0 4px 18px rgba(22,163,74,0.3)' }
                    : { background: '#2563eb', boxShadow: '0 4px 20px rgba(37,99,235,0.35)' }
                  }
                >
                ...
                <a
                  ...
                  className="w-full flex items-center justify-center gap-3 py-4 rounded-2xl text-base font-bold transition-all duration-150 active:scale-[0.98]"
                  style={{ background: 'white', border: '2px solid #16a34a', color: '#15803d', boxShadow: '0 2px 8px rgba(22,163,74,0.12)' }}
                >
                  {WA_SVG}
