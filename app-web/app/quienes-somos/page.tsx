      ...
      <main className="flex-1">
        ...
        <section className="max-w-5xl mx-auto px-6 py-16">
          <div className="rounded-3xl p-10 md:p-14 text-center" style={{ background: '#030712' }}>
            ...
            <button onClick={() => router.push('/')}
              className="px-8 py-3.5 rounded-xl font-bold text-sm text-white transition-all hover:opacity-90 mr-3"
              style={{ background: '#2563eb' }}>
              Ver catálogo
            </button>
            <a href={WA} target="_blank" rel="noopener noreferrer"
              className="inline-block px-8 py-3.5 rounded-xl font-bold text-sm text-white transition-all hover:opacity-90"
              style={{ background: '#16a34a' }}>
              Contáctanos
            </a>
          </div>
