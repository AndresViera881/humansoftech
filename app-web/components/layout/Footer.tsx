...
export default function Footer() {
  ...
  return (
    <footer className="bg-gray-950 border-t border-white/5">
      ...
      {/* WhatsApp CTA banner */}
      <div className="bg-gradient-to-r from-green-900/30 via-green-800/20 to-green-900/30 border-b border-green-500/10">
        <div className="max-w-7xl mx-auto px-6 py-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-xl bg-green-500/15 border border-green-500/20 flex items-center justify-center flex-shrink-0">
              <svg className="w-4.5 h-4.5 text-green-400" viewBox="0 0 24 24" fill="currentColor" style={{ width: 18, height: 18 }}>
            ...
            <div>
              <p className="text-sm font-bold text-white">¿Tenés alguna consulta?</p>
              <p className="text-xs text-green-400/80">Respondemos en minutos por WhatsApp</p>
            </div>
          </div>
          <a href={`https://wa.me/${WA_PHONE}`} target="_blank" rel="noopener noreferrer"
            className="flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-bold text-white bg-green-600 hover:bg-green-500 transition-colors duration-150 flex-shrink-0">
