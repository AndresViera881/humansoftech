    ...
    <footer style={{ background: '#111827', borderTop: '1px solid rgba(255,255,255,0.06)' }}>
            ...
            {[
              {
                ...
                label: 'Móvil', value: '+593 9953 514 73', href: `https://wa.me/${WA_PHONE}`,
              },
              {
                ...
                label: 'Web', value: 'humansoftechs.com', href: 'https://humansoftechs.com',
              },
      ...
      <div style={{ borderTop: '1px solid rgba(255,255,255,0.06)' }}>
        <div className="w-full px-6 py-3 flex items-center justify-center text-center">
          <span className="text-xs tracking-widest uppercase" style={{ color: '#ffffff', letterSpacing: '0.1em' }}>
